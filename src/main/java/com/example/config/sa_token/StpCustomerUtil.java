...
public class StpCustomerUtil {
    ...
    /**
     * 获取当前 TokenUtil 的扩展信息（此函数只在jwt模式下生效）
     *
     * @param key 键值
     * @return 对应的扩展数据
     */
    ...
    /**
     * 获取指定 TokenUtil 的扩展信息（此函数只在jwt模式下生效）
     *
     * @param tokenValue 指定的 TokenUtil 值
     * @param key        键值
     * @return 对应的扩展数据
     */
    ...
    /**
     * 获取当前匿名 TokenUtil-Session （可在未登录情况下使用的Token-Session）
     *
     * @return TokenUtil-Session 对象
     */
    ...
    /**
     * 获取当前 TokenUtil-Session 剩余有效时间 (单位: 秒)
     *
     * @return token剩余有效时间
     */
    ...
    /**
     * 指定 TokenUtil 是否处于二级认证时间内
     *
     * @param tokenValue TokenUtil 值
     * @param service    业务标识
     * @return true=二级认证已通过, false=尚未进行二级认证或认证已超时
     */
